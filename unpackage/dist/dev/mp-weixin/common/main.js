...
/***/ 0:
/*!*****************************************!*\
  !*** D:/www/svn_uniapp/reserve/main.js ***!
  \*****************************************/
...
var Api = _interopRequireWildcard(__webpack_require__(/*! ./config/api.js */ 42));
var Common = _interopRequireWildcard(__webpack_require__(/*! ./config/common.js */ 43));
var Db = _interopRequireWildcard(__webpack_require__(/*! ./config/db.js */ 44));
var Config = _interopRequireWildcard(__webpack_require__(/*! ./config/config.js */ 37));
...
/***/ 27:
/*!*****************************************!*\
  !*** D:/www/svn_uniapp/reserve/App.vue ***!
  \*****************************************/
/*! no static exports found */
...
/***/ 28:
/*!******************************************************************!*\
  !*** D:/www/svn_uniapp/reserve/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _wechat = _interopRequireDefault(__webpack_require__(/*! @/config/wechat/wechat */ 30));
var _default = {
  onLaunch: function onLaunch() {
    ...
    this.$api.init({}, function (data) {
      if (data.code === 1) {
        ...
        var autologin = data.data.wechat.autologin;
        var userInfo = uni.getStorageSync('user');
        var againStatus = uni.getStorageSync('againStatus');
        uni.setStorageSync('payment', payment);
        var appid = data.data.wechat.appid;
        uni.setStorageSync('appid', appid);
        //let token=wechat.getWxMiniProgramSessionKey(true)
        if (!userInfo && autologin) {
          _wechat.default.getWxMiniProgramSessionKey(true).then(function (result) {
            uni.showLoading({
              title: '自动登录中...'
            });
            uni.setStorageSync('token', result);
            if (result) {
              _this.$http('third.refreshUser', {}).then(function (val) {
                if (val.code == 1) {
                  _this.$db.set('user', val.data.user);
                  _this.$db.set('auth', val.data.auth);
                  _this.$db.set('islogin', true);
                  _this.$emit('closeBottom', val.data.user);
                } else {
                  _this.$common.errorToShow(val.msg);
                  _this.$db.del('user');
                  _this.$db.del('auth');
...
/***/ 39:
/*!**************************************************************************!*\
  !*** D:/www/svn_uniapp/reserve/App.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 40:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/www/svn_uniapp/reserve/App.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
